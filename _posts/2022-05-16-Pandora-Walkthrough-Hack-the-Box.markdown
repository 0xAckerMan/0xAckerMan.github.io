---
layout: post
title: "Pandora Walkthrough - Hack the Box"
date: 2022-05-16 13:32:20 +0300
description: You’ll find this post in your `_posts` directory. Go ahead and edit it and re-build the site to see your changes. # Add post description (optional)
img: pandora-htb.png # Add image post (optional)
...
![img](https://i.imgur.com/zfuY6pd.png)
...
![img](https://i.imgur.com/HYlk1u7.png)
...
![img](https://i.imgur.com/7QqrEA5.png)
...
![img](https://i.imgur.com/C40eqRr.png)

Now we have to get a way to exploit a reverse shell.

![gif](https://i.imgur.com/Ji5s8yp.gif)
...
![img](https://i.imgur.com/6LNEqtK.png)

Lets visit the php file we uploaded
![img](https://i.imgur.com/Z0QmcH5.png)
...
![img](https://i.imgur.com/cQbmXMq.png)

we get a connection back. Lets now read the user hash.

![img](https://i.imgur.com/cM4HKeW.png)
...
![img](https://i.imgur.com/ju7VVuf.png)
...
![img](https://i.imgur.com/pkko3Sm.png)


Congratulations!!! Pandora has been pwned

![img](https://i.imgur.com/MaLSWK2.png)
...
[![img](https://i.imgur.com/WKRV9rx.png)](https://www.buymeacoffee.com/k0r3s)
